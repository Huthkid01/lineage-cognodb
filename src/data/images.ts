...
export const ARTWORK_IMAGES: Record<string, string> = {
  ...
  "w-mine": u("photo-1504328345606-18bbc8c9d7d1"), // mine / industrial night
  "w-ink": u("photo-1455390582262-044cdead277a"), // ink on paper
  "w-kites": u("photo-1571849291280-89f81a772893"), // kites in sky
  ...
  "w-signal": u("photo-1477959858617-67f85cf4f1df"), // night city lights
